...
import { closeDeleteIssueModalAction, deleteIssueAction } from '../../redux/actions/deleteIssueAction'
...
const AllIssuesView = () => {
    ...
    return (
        <>
            <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className={styles.allIssuesView}>
                    ...
                    <motion.div initial={{opacity: 0}} animate={{opacity: 1}} exit={{opacity: 0}} className={styles.modalLogout}>
                        <div className={styles.cardLogout}>
                            ...
                            <div className={styles.buttonModal}>
                                <button onClick={handleConfirmDelete}><AiOutlineCheck /></button>
